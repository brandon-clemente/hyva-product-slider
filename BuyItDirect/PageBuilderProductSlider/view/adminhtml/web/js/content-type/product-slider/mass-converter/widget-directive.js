...
define(["Magento_PageBuilder/js/mass-converter/widget-directive-abstract", "Magento_PageBuilder/js/utils/object"], function (_widgetDirectiveAbstract, _object) {
    ...
    var WidgetDirective = /*#__PURE__*/function (_widgetDirectiveAbstr) {
        ...
        _proto.fromDom = function fromDom(data, config) {
            ...
            data.show_arrows = attributes.show_arrows;
            data.show_dots = attributes.show_dots;
            data.per_view = attributes.per_view;
            data.show_prices = attributes.show_prices;
            return data;
        }
        /**
        ...
        _proto.toDom = function toDom(data, config) {
            var attributes = {
                ...
                template: "BuyItDirect_PageBuilderProductSlider::catalog/product/widget/content/slider.phtml",
                anchor_text: "",
                id_path: "",
                show_pager: 0,
